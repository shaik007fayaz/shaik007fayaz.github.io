...
const bentoCategories = [
  {
    ...
    badge: 'CORE PILLAR',
    items: ['React.js', 'Angular', 'TypeScript', 'HTML5', 'CSS3', 'Bootstrap'],
    description:
      'Building responsive and reusable user interfaces with React.js and Angular, focusing on clean component architecture, responsive layouts, API integration, and user experience.',
    stat: 'RESPONSIVE UI',
...

  {
    ...
    badge: 'CORE BACKEND',
    items: ['ASP.NET Core', 'C#', 'RESTful APIs', 'Node.js', 'Express.js', 'Microservices'],
    description:
      'Developing scalable backend services and RESTful APIs using ASP.NET Core and C#. Experienced in CRUD operations, API integration, backend architecture, troubleshooting, and enterprise application development.',
...

  {
    title: 'DATABASE & DATA',
    badge: 'DATA LAYER',
    items: ['SQL Server', 'MongoDB', 'MySQL', 'SQL', 'Database Optimization'],
    description:
      'Working with relational and NoSQL databases to build reliable database-driven applications, implement CRUD functionality, integrate backend services, and optimize database operations.',
    stat: 'SQL & NOSQL',
    colSpan: 'lg:col-span-5',
  },

  {
    ...
    description:
      'Building and supporting cloud-based applications using Microsoft Azure and AWS. Experienced with serverless solutions, application deployment, secure configuration, monitoring, CI/CD pipelines, and DevOps workflows.',
    stat: 'AZURE & AWS',
    colSpan: 'lg:col-span-7',
  },
];
